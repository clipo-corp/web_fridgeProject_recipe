...
const ko = {
  ...
  "hero.title2": "뭐 해 먹지?",
  "hero.subtitle": "레시피를 빠르게 찾아보고, 저장과 맞춤 추천은 앱에서 이어가세요.",
  "hero.searchPlaceholder": "레시피명 또는 재료를 검색하세요",
  "hero.searchAria": "레시피 검색",
  "hero.searchScopeLabel": "검색 범위",
  "hero.searchScopeAll": "전체",
  "hero.searchScopeRecipe": "레시피명",
  "hero.searchScopeIngredient": "재료",
  ...
  "results.pagination": "검색 결과 페이지",
  "results.pageRange": "{start}-{end} / {total}개 표시",
  "results.prev": "이전",
  "results.next": "다음",
  "results.pageLabel": "{page}페이지로 이동",
  ...
  "installPage.secondary": "웹 레시피 보기",
  "installPage.phoneTitle": "설치 후 바로 시작",
  "installPage.phoneBody": "저장한 레시피와 재료를 앱에서 이어가기",
  "installPage.features": "앱 주요 기능",
  "installPage.feature1": "재료 등록과 관리",
  "installPage.feature2": "레시피 저장",
  "installPage.feature3": "맞춤 추천 받기",
} as const;
...
const en: Record<TranslationKey, string> = {
  ...
  "hero.searchPlaceholder": "Search for a recipe name or ingredient",
  "hero.searchAria": "Search recipes",
  "hero.searchScopeLabel": "Search scope",
  "hero.searchScopeAll": "All",
  "hero.searchScopeRecipe": "Recipe name",
  "hero.searchScopeIngredient": "Ingredient",
  ...
  "results.pagination": "Search result pages",
  "results.pageRange": "Showing {start}-{end} of {total}",
  "results.prev": "Previous",
  "results.next": "Next",
  "results.pageLabel": "Go to page {page}",
  ...
  "installPage.badge": "Download Keep Cook",
  "installPage.title": "Install the app for recipes that fit your fridge",
  "installPage.body":
    "Save recipes, manage fridge ingredients, and continue with ingredient-based recommendations in the Keep Cook app.",
  "installPage.primary": "Get the app",
  "installPage.secondary": "Browse web recipes",
  "installPage.phoneTitle": "Start right after install",
  "installPage.phoneBody": "Continue saved recipes and ingredients in the app",
  "installPage.features": "App features",
  "installPage.feature1": "Add and manage ingredients",
  "installPage.feature2": "Saved recipes",
  "installPage.feature3": "Personalized recommendations",
};
